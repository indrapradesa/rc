...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url() ?>index.php/dashboarddkp/logoutdkp" type="submit" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="http://localhost/rc/c_dkp/c_statusdkp">
            <i class="fa fa-list"></i> <span>Status</span>
          </a>
        </li>
    </section>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <!-- small box -->
          <b><h2>Selamat datang <?php echo $this->session->userdata("nama_kryn") ?></h2></b>
          <b><h3>Selamat Bekerja.</h3></b>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
