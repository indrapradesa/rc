      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="http://localhost/rc/c_dkp/c_statusdkp"><i class="fa fa-circle-o"></i>Pengambilan</a></li>
            <li class="active"><a href="http://localhost/rc/c_rc/c_statusdkp/validasi"><i class="fa fa-circle-o"></i>Validasi</a></li>
          </ul>
        </li>
    </section>
    <!-- /.sidebar -->
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href=<?php echo base_url() ?>c_dkp/c_statusdkp/statusn/<?php echo $hasil->id_map ?> class="btn btn-sm btn-success">Ubah Status</a>
                    </td>
                  </tr>
