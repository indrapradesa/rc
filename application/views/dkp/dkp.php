...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="http://localhost/rc/c_rc/c_statusdkp/validasi"><i class="fa fa-circle-o"></i>Validasi</a></li>
          </ul>
        </li>
    </section>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <b>Selamat datang, <?php echo $this->session->userdata("nama_kryn") ?></b>
    </section>
