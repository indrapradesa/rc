...
$(document).ready(function(){
  $("[id=s]").css("background-color", "yellow");
});
</script>
</head>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="http://localhost/rc/c_rc/c_pembayaran"><i class="fa fa-circle-o text-aqua"></i> Data Pembayaran <small class="label pull-right bg-aqua">
      ...
      <div class="row">
        <div class="col-xs-12">
           <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <p><a href="http://localhost/rc/c_rc/c_pembayaran/cetak" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $hasil->tot ?> Kg</td>
                    <td>Rp. <?php echo $hasil->p_plas ?></td>
                    <td>Rp. <?php echo $hasil->p_bes ?></td>
                    <td>Rp. <?php echo $hasil->p_ker ?></td>
                    <td>Rp. <?php echo $hasil->p_tot ?></td>
                    <td><span class="label label-success"><?php echo $hasil->status ?></td>
                    <td><span class="label label-success"><?php echo $hasil->p_status ?></td>
                    <td>
                        <a href=<?php echo base_url() ?>c_rc/c_pembayaran/total/<?php echo $hasil->id_map ?> class="btn btn-sm btn-success"
                        >Total</a>
                        <a href=<?php echo base_url() ?>c_rc/c_pembayaran/bayar/<?php echo $hasil->id_pmbyr ?> class="btn btn-sm btn-success">Bayar</a>
                    </td>
                  </tr>
        ...
        <div class="col-md-6">
          <div class="box box-solid">
            ...
            <div class="box-body">
              <dl>
                <dt>Keterangan Status :</dt>
                <dd>Rekap terlebih dahulu sebelum penghapusan data status.</dd>
              </dl>
            </div>
           /.box -->
        </div>
...
<script type="text/javascript"> 
  function cek_tot(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>c_pembayaran/get_ajax",
      data: {p_: p_},
      async : false,
      dataType: 'json',
      success: function(data){
        if(data.length>0){
          alert("Anda sudah melakukan Pentotalan");
          return false;
        }else{
          return true;
        }
