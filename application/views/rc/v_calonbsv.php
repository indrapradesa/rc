      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="http://localhost/rc/c_rc/c_calonbs/validasi"><i class="fa fa-circle-o text-green"></i> Data Tervalidasi</a></li>
          </ul>
        </li>
    </section>
    <!-- /.sidebar -->
        ...
        <div class="col-xs-12">
           <div class="box">
            <div class="box-header">
              <h3 class="box-title">Bank Sampah Tervalidasi</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr style="text-align: center;">
                    ...
                    <td><span class="label label-success"><?php echo $hasil->v_status ?></span></td>
                    <td>
                        <a href=<?php echo base_url() ?>c_rc/c_calonbs/tdkaktif/<?php echo $hasil->id_dbs ?> class="btn btn-sm btn-danger">Non Aktif</a>
