      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="http://localhost/rc/c_rc/c_status"><i class="fa fa-circle-o text-red"></i>Pengambilan</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="http://localhost/rc/c_rc/c_pembayaran"><i class="fa fa-circle-o text-aqua"></i> Data Pembayaran</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="http://localhost/rc/c_rc/c_calonbs"><i class="fa fa-circle-o text-yellow"></i> Data Calon Bank Sampah</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Tables</li>
        <li class="active">Data Bank Sampah</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
               <?php //foreach($daftarbs as $u){ ?>
              <form action="<?php echo base_url('c_rc/c_bs/editbs/'.$daftarbs->id_dbs) ?>" method="post">
                <input type="hidden" name="id" value="<?php echo $daftarbs->id_dbs?>" />

                  <div class="form-group">
                    <label for="name">Nama Penggurus</label>
                    <input class="form-control <?php echo form_error('n_penggurus') ? 'is-invalid':'' ?>"
                     type="text" name="n_penggurus" placeholder="n_penggurus" value="<?php echo $daftarbs->n_penggurus ?>" readonly />
                    <div class="invalid-feedback">
                      <?php echo form_error('n_penggurus') ?>
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="price">Nama BS</label>
                    <input class="form-control <?php echo form_error('nama_bs') ? 'is-invalid':'' ?>"
                     type="text" name="nama_bs" min="0" placeholder="nama_bs" value="<?php echo $daftarbs->nama_bs ?>" readonly />
                    <div class="invalid-feedback">
                      <?php echo form_error('nama_bs') ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control-file <?php echo form_error('f_ktp') ? 'is-invalid':'' ?>"
                     type="file" name="image" />
                    <input type="hidden" name="f_ktp" value="<?php echo $daftarbs->f_ktp ?>" />
                    <img src="<?php echo base_url()?>assets/images/<?php echo $daftarbs->f_ktp ?>" width="100" alt="" name="f_ktp">
                    <div class="invalid-feedback">
                      <?php echo form_error('f_ktp') ?>
                    </div>
                  </div>
