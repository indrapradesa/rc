        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <form action="<?php echo base_url('c_rc/c_bs/update/'.$u->id_dbs) ?>" method="post">
                <div class="form-group">
                 <label>Nama Penggurus :</label>
                   <input type="text" class="form-control" id="n_penggurus" name="n_penggurus" value="<?php echo $u->n_penggurus ?>">
                </div>
                <div class="form-group">
                 <label>Alamat :</label>
                ...
                <div class="form-group">
                 <label>Password :</label>
                   <input type="password" class="form-control" id="password" name="password" required="" minlength="1" maxlength="16">
                </div>
                <div class="form-group">
                 <label>Nama BS :</label>
                   <input type="text" class="form-control" id="nama_bs" name="nama_bs" value="<?php echo $u->nama_bs ?>">
                </div>
                <div class="form-group">
                 <label>Foto Struktur Organisai :</label>
                   <input type="file" id="f_ktp" name="f_ktp">
                   <img src="<?php echo base_url()?>assets/images/<?php echo $u->f_ktp ?>" width="100" alt="" name="f_ktp">
                 </div>
                 <div class="form-group">
                 <label>Foto SK Desa :</label>
                   <input type="file" id="f_sk" name="f_sk">
                   <img src="<?php echo base_url()?>assets/images/<?php echo $u->f_sk ?>" width="100" alt="" name="f_sk">
                 </div>
                 <div class="form-group">
                 <label>Foto Foto Profil :</label>
                   <input type="file" id="f_profil" name="f_profil">
                   <img src="<?php echo base_url()?>assets/images/<?php echo $u->f_profil ?>" width="100" alt="" name="f_profil">
                 </div>
