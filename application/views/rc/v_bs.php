      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="<?php echo base_url() ?>user/tambah/" class="btn btn-md btn-primary">Tambah User</a>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $hasil->v_status ?></td>
                    <td>
                        <a href="<?php echo base_url() ?>c_rc/c_bs/lihat/<?php echo $hasil->id_dbs ?>" class="btn btn-sm btn-primary">Lihat</a>
                        <a href="<?php echo base_url() ?>c_rc/c_bs/edit/<?php echo $hasil->id_dbs ?>" class="btn btn-sm btn-success">Edit</a>
                        <a href="<?php echo base_url() ?>c_rc/c_bs/grafik/" class="btn btn-sm btn-danger">Hapus</a>
