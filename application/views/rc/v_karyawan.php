      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="http://localhost/rc/c_rc/c_karyawan"><i class="fa fa-circle-o text-aqua"></i> Data Karyawan</a></li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    $no = 1; 
                    foreach($data_kyn as $hasil){ 
                ?>

                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $hasil->nik ?></td>
                    <td><?php echo $hasil->n_lengkap ?></td>
                    <td><?php echo $hasil->nama_kryn ?></td>
