    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="http://localhost/rc/c_rc/c_calonbs"><i class="fa fa-circle-o text-yellow"></i>Calon Bank Sampah <small class="label pull-right bg-yellow">
        ...
        <div class="col-xs-12">
           <div class="box">
            <div class="box-header">
              <h3 class="box-title">Calon Bank Sampah</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr style="text-align: center;">
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $hasil->n_penggurus ?></td>
                    <td><?php echo $hasil->alamat ?></td>
                    <td><?php echo $hasil->email ?></td>
                    <td><?php echo $hasil->nama_bs ?></td>
                    <td><?php echo $hasil->bs_status ?></td>
                    <td><span class="label label-warning"><?php echo $hasil->v_status ?></span></td>
                    <td>
                        <a href=<?php echo base_url() ?>c_rc/c_calonbs/aktif/<?php echo $hasil->id_dbs ?> class="btn btn-sm btn-success">Aktif</a>
                        <a href=<?php echo base_url() ?>c_rc/c_calonbs/bs_nonaktif/<?php echo $hasil->id_dbs ?> class="btn btn-sm btn-danger">Non Aktif</a>
                        <a href=<?php echo base_url() ?>c_rc/c_calonbs/vstatus/<?php echo $hasil->id_dbs ?> class="btn btn-default btn-sm mb">Validasi</a>
                    </td>
                  </tr>
