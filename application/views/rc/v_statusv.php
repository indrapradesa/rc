      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="http://localhost/rc/c_rc/c_status/validasi"><i class="fa fa-circle-o text-yellow"></i>Terproses <small class="label pull-right bg-yellow">
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><span class="label label-success"><?php echo $hasil->status ?></span></td>
                    <td>
                        <a href="" class="btn btn-sm btn-success">Edit</a>
                        <a href="" class="btn btn-sm btn-danger">Hapus</a>
                        <a href=<?php echo base_url() ?>c_rc/c_status/statusn/<?php echo $hasil->id_map ?> class="btn btn-default btn-sm mb">Selesai</a>
                    </td>
                  </tr>
