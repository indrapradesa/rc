      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="http://localhost/rc/c_rc/c_status/selesai"><i class="fa fa-circle-o text-green"></i>Terselesaikan</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <div class="row">
        <div class="col-xs-12">
           <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <p><a href="http://localhost/rc/c_rc/c_status/cetak_rekap" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $hasil->plas ?> /Kg</td>
                    <td><?php echo $hasil->bes ?> /Kg</td>
                    <td><?php echo $hasil->ker ?> /Kg</td>
                    <td><?php echo $hasil->tot ?> /Kg</td>
                    <td><span class="label label-info"><?php echo $hasil->status ?></span></td>
                    <td>
                        <a href="" class="btn btn-sm btn-success">Edit</a>
                        <a href="" class="btn btn-sm btn-danger">Hapus</a>
                        <!-- <a href=<?php echo base_url() ?>c_rc/c_status/total/<?php echo $hasil->id_map ?> class="btn btn-default btn-sm mb">Ubah Status</a> -->
                    </td>
                  </tr>
