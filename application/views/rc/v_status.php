      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="http://localhost/rc/c_rc/c_status"><i class="fa fa-circle-o text-red"></i>Pengambilan <small class="label pull-right bg-red">
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><span class="label label-danger"><?php echo $hasil->status ?></span></td>
                    <td>
                        <a href="" class="btn btn-sm btn-danger">Hapus</a>
                        <a href=<?php echo base_url() ?>c_rc/c_status/status/<?php echo $hasil->id_map ?> class="btn btn-sm btn-success">Anggkut</a>
                    </td>
                  </tr>
