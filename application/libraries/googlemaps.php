...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyAV7B2KUij2mym0LkffDUSG8XenLyyFUFM'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $region						= 'IDN';						// Country code top-level domain (eg "uk") within which to search. Useful if supplying addresses rather than lat/longs
	...
	var	$trafficOverlay				= TRUE;					// If set to TRUE will overlay traffic information onto the map by default 
	...
	function add_marker($params = array())
	{
		...
		$marker['icon'] = FALSE;									// The name or url of the icon to use for the marker
